<template>
  <div class="mb-4">
    <h4 style="font-weight: 700" class="my-3" @click="changeLoc"><b-icon variant="primary" icon="geo-alt"></b-icon
                  > Location</h4>
    <div class="d-flex flex-row flex-wrap justify-content-center my-2">
      ...
      <div class="mx-5" v-if="permissionCheck">
        What to use for location?

        <div class>
          <b-button class="bg-danger border-danger m-2" @click="useIP()">IP</b-button>
          <b-button class="bg-success border-success m-2" @click="useGPS()">GPS</b-button>
        </div>
      </div>
    </div>
